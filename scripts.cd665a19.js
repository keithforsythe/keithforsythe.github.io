...
function init() {
  var appStateToggle = document.querySelector('.js-appstate-toggle');
  var mobileAppStateToggle = document.querySelector('.js-mobileapp-toggle');
  var appState = document.querySelector("#app");
  var modalWindow = document.querySelectorAll('.js-modal-window');
  var modalWindowLauncher = document.querySelectorAll('.js-modal-toggle');
  var modalWindowClose = document.querySelectorAll('.js-modal-close'); //Helper Functions
  ...
  for (var i = 0; i < modalWindowLauncher.length; i++) {
    modalWindowLauncher[i].addEventListener('click', function () {
      ...
      var modalViewed = document.querySelector("[data-window=\"".concat(clickedData, "\"]"));
      modalViewed.classList.toggle('is-active');
      var images = document.querySelectorAll(".modal.is-active img"); //Load img source only when user clicks sample modal toggle
  ...
  for (var i = 0; i < modalWindowClose.length; i++) {
    modalWindowClose[i].addEventListener('click', function () {
      var modalCloseButton = event.currentTarget;
